"""
IndoLens Desktop – Aplikasi Utama
================================

Tujuan:
    Aplikasi desktop overlay realtime untuk pengenalan wajah aktor
...
# Konfigurasi Integrasi Tahap 6 (Tidak di-hardcode)
...
class ControllerWindow(QWidget):
    def __init__(self, all_embeddings):
        ...
        # Integration Button (Tahap 6)
        self.btn_actor_list = QPushButton("📚 Actor List")
        self.btn_actor_list.clicked.connect(self.open_actor_list)
        layout.addWidget(self.btn_actor_list)
    ...
    def open_actor_list(self):
        # Membuka halaman Laravel di browser default, tanpa IPC atau REST API (Revisi Scope Skripsi)
        webbrowser.open(f"{LARAVEL_URL}/actors")
...
def main():
    print("\n" + "=" * 60)
    print("  IndoLens Desktop – Tahap 6 (Final): Integration")
